...
-- (CREATE SESSION, CREATE ANY TABLE, ALTER ANY TABLE, etc.) sao criados
-- por um script separado, database_config_vendasods.sql, neste mesmo
-- diretorio. Este script assume que o usuario "vendasods" ja existe e
-- esta conectado (rodar como vendasods).
--
-- IMPORTANTE: alem do "GRANT CREATE TRIGGER TO vendasods" ja previsto em
-- database_config_vendasods.sql, este script tambem precisa de:
