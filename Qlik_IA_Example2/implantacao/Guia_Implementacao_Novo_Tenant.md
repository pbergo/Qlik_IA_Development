...
- ~~**Inconsistência no service name Oracle**~~ — **Resolvido em 2026-07-23**: `di-oracle.md` e `da-oracle.md` agora usam `XEPDB1`, confirmado via conexão direta ao Oracle fonte (`192.168.1.27:1521/XEPDB1`, schema `VENDASODS`).
